...
gulp.task('rename', function ()  {
    ...
    if (!newname) {
        console.log('Please write the new moma name, like: "gulp rename --name mywidgetset" --author "Author Name"');
        process.exit();
    }
    ...
    if (fs.existsSync(__dirname + '/admin/moma.png')) {
        fs.renameSync(__dirname + '/admin/moma.png',              __dirname + '/admin/' + newname + '.png');
    }
    if (fs.existsSync(__dirname + '/widgets/moma.html')) {
        fs.renameSync(__dirname + '/widgets/moma.html',           __dirname + '/widgets/' + newname + '.html');
    }
    if (fs.existsSync(__dirname + '/widgets/moma/js/moma.js')) {
        fs.renameSync(__dirname + '/widgets/moma/js/moma.js', __dirname + '/widgets/moma/js/' + newname + '.js');
    }
    if (fs.existsSync(__dirname + '/widgets/moma')) {
        fs.renameSync(__dirname + '/widgets/moma',                __dirname + '/widgets/' + newname);
    }
    var patterns = [
        {
            match: /moma/g,
        ...
        {
            match: /awhiteknight@unity-mail.de/g,
            replacement: email
        }
    ];
    var files = [
