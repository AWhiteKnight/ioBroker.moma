...
const sysInfo = {
    ...
    'versions': {
        ...
        'pip':              {'type': 'string',  'role': 'text'},
        'pip3':             {'type': 'string',  'role': 'text'},
        ...
        'cpus': [
            {
                ...
                // 'raw_load':    {'type': 'number',  'role': 'value'}
                //...
            }
        ]
    },
...
function createEntry(adapter, entry, parent, id, level) {
    ...
    // adapter.log.debug('entry ' + newId + ': ' + JSON.stringify(entry));
