...
const sysInfo = {
    ...
    'dockerInfo': {
        ...
        'noProxy': {'type': 'boolean', 'role': 'indicator'},
        'name': {'type': 'string', 'role': 'text'},
        'labels': {'type': 'string', 'role': 'text'},
        ...
        'isolation': {'type': 'boolean', 'role': 'indicator'},
...
function createMetaState(adapter, id, varRole, varType) {
    let state = {
        _id:  id,
        type: 'state',
        common: {
