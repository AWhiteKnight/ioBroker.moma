...
module.exports.sysInfo = {
    ...
    "processes": {
        "all":      {"id": "state.processes.all",       "type": "number",   "role": ""},
        "running":  {"id": "state.processes.running",   "type": "number",   "role": ""},
        "blocked":  {"id": "state.processes.blocked",   "type": "number",   "role": ""},
        "sleeping": {"id": "state.processes.sleeping",  "type": "number",   "role": ""},
        "unknown":  {"id": "state.processes.unknown",   "type": "number",   "role": ""}
    }
}
