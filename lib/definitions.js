...
module.exports.sysInfo = {
    ...
    "battery": {
        "hasbattery":       {"id": "state.battery.hasbattery",      "type": "boolean",  "role": ""},
        "cyclecount":       {"id": "state.battery.cyclecount",      "type": "number",   "role": ""},
        "ischarging":       {"id": "state.battery.ischarging",      "type": "boolean",  "role": ""},
        "maxcapacity":      {"id": "state.battery.maxcapacity",     "type": "number",   "role": ""},
        ...
        "type":             {"id": "state.battery.type",            "type": "string",   "role": ""},
        "model":            {"id": "state.battery.model",           "type": "string",   "role": ""},
        "manufacturer":     {"id": "state.battery.manufacturer",    "type": "string",   "role": ""},
        "serial":           {"id": "state.battery.serial",          "type": "string",   "role": ""}
    }
}
...
module.exports.sysTemplates = {
    ...
    "graphiccontroller": {
        "model":        {"id": "layout.graphiccontroller.x.model",          "type": "string",   "role": ""},
        "vendor":       {"id": "layout.graphiccontroller.x.vendor",         "type": "string",   "role": ""},
    ...
    "display": {
        "model":        {"id": "layout.display.x.model",        "type": "string",   "role": ""},
        "main":         {"id": "layout.display.x.main",         "type": "string",   "role": ""},
        "builtin":      {"id": "layout.display.x.builtin",      "type": "boolean",  "role": ""},
        "connection":   {"id": "layout.display.x.connection",   "type": "string",   "role": ""},
